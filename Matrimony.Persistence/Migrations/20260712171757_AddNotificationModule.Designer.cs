...
namespace Matrimony.Persistence.Migrations
{
    ...
    [Migration("20260712171757_AddNotificationModule")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Matrimony.Domain.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Matrimony.Domain.Entities.PartnerPreference", b =>
                {
                    ...
                    b.Property<bool>("AcceptDivorced")
                        .HasColumnType("bit");

                    b.Property<bool>("AcceptWidowed")
                        .HasColumnType("bit");

                    b.Property<bool>("AcceptWithChildren")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Matrimony.Domain.Entities.PartnerPreference", b =>
                {
                    ...
                    b.HasOne("Matrimony.Domain.Entities.ApplicationUser", "User")
                        .WithOne()
                        .HasForeignKey("Matrimony.Domain.Entities.PartnerPreference", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
